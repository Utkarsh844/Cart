...
<h2>Shopping Cart</h2>
<img src="cart.jpg" style="width:304px;height:228px;">
<body onload="runBGSlideShow()">
<center>
<form class="form-style-4" action = "/confirm"  method="post">
<h1><b><u>Cart Detail Management</u></b></h1>
<label for="names">
...
<label for="startL">
<span>Cart items</span><textarea name="startL" required="true"></textarea>
</label>
<label for="endL">
<span>Cart item type</span><input type="text" name="endL" required="true" />
</label>
<label>
